function [ dip, xl, xu, ifault, gcm, lcm, mn, mj ] = diptest( xpdf ) 
% DIPTEST computes Hartigan's dip statistic.
% 
% Usage:
% [dip,xl,xu, ifault, gcm, lcm, mn, mj] = diptest( xpdf )
%
% This is a direct translation by F. Mechler (August 27 2002)
% into MATLAB from the original FORTRAN code of Hartigan's Subroutine 
% DIPTST algorithm.
...
% unimodal input. This check was omitted in the original Hartigan 
% algorithm, leading to an infinite cycle.
%
...
% optional results, which include the modal interval (XL,XU), an error flag
% IFAULT (>0 flags an error), as well as the minorant and majorant fits 
